...
import com.decadroid.activities.EditIssueCommentActivity;
import com.decadroid.activities.EditPullRequestCommentActivity;
import com.decadroid.model.StatusWrapper;
import com.decadroid.model.TimelineItem;
...
import com.decadroid.widget.CommitStatusBox;
import com.decadroid.widget.PullRequestBranchInfoView;
    ...
    public void editComment(GitHubCommentBase comment) {
        final @AttrRes int highlightColorAttr = mPullRequest.merged()
                ...
                : mPullRequest.state() == IssueState.Closed
                        ? R.attr.colorSecondaryContainer : R.attr.colorPrimaryContainer;
